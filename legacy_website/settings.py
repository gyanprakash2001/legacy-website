...
ALLOWED_HOSTS = ['.render.com', 'localhost', '127.0.0.1', 'legacy-website-dg1.onrender.com']
...
# This line links your media files to your project
# You need to add it to your settings.py file
# and also update your urls.py file to serve the media files
